import { words as INITIAL_WORDS } from './data.js'
    ...
    //const TEXT = 'the quick brown fox jumps over the lazy dog and rodidev is trying to clone monkey type for fun and profit using vanilla ja for the test speed';
    ...
    function initGame(){
        ...
        //words = INITIAL_WORDS.slice(0, 32)
    ...
    function onKeyDown(event){
        ...
        if(key === 'Backspace'){
            ...
            if($wordMarked && !$prevLetter){
                ...
                //...para transformarlo a array y usar el map
                $input.value = [
    ...
    function gameOver(){
        ...
        $correct.textContent = correctLetter +' / '+ incorrectLetter
